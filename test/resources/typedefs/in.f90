...
contains
  ...
  function SimpleFunction2(some_ptr, val) bind(c, name="SimpleFunction2")
    type(c_ptr), intent(in), value  :: some_ptr
  ...
  function SimpleFunction3(some_ptr, val) bind(c, name="SimpleFunction3")
    type(c_ptr), intent(in), value  :: some_ptr
    real*8, intent(in), value       :: val
